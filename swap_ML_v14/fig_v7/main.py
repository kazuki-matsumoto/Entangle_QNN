...
if __name__ == "__main__":
    ...
    for datasize in [100, 200, 300, 400]:
        
        FOLDER_PATH = 'datasize_{}/'.format(datasize)
        FIG_NAME_LOSS = FOLDER_PATH + 'graph_loss_datasize_{}.jpeg'.format(datasize)
        FIG_NAME_ACCURACY = FOLDER_PATH + 'graph_accuracy_datasize_{}.jpeg'.format(datasize)
        ...
        if NUM_CLASS <= 4:
            ...
            df_dict = {}
            df = datasets(NUM_CLASS, NUM_FEATCHERS, datasize)
